///Contains projects inoformation.
final List<Map<String, Object>> projectsData = [
  {
    'projectID': 1,
    'projectName': 'Trivia Game',
    'projectDesc': 'A trivia platform to test your knowledge and have fun.'
  ...
  {
    'projectID': 4,
    'projectName': 'Group Chat Messaging Application',
    'projectDesc':
        'A platform for group messaging. This project Showcase the use of '
  ...
  {
    'projectID': 5,
    'projectName': 'Data Structures: Implementing the Stack and LinkedList',
    'projectDesc': 'This project shows how to implement a Stack Data Structure.'
  ...
  },
  {
    ...
    'projectDesc': 'A project to showcase shopping experience on the web. '
